...
const peggyParser: { parse: any; SyntaxError: any; DefaultTracer?: any } = // Generated by Peggy 3.0.2.
  ...
  (function () {
    ...
    function peg$parse(input, options) {
      ...
      var peg$f22 = function (layer, x1, y1, x2, y2, props) {
        // @ts-ignore
        return {
          // @ts-ignore
          type: 'Line',
      ...
      var peg$f23 = function (layer, x1, y1, x2, y2, props) {
        // @ts-ignore
        return {
          // @ts-ignore
          type: 'Rectangle',
      ...
      var peg$f24 = function (layer, pointCount, points, props) {
        // @ts-ignore
        return {
          // @ts-ignore
          type: 'Polygon',
      ...
      var peg$f26 = function (x, y) {
        // @ts-ignore
        return { x, y };
      }; // @ts-ignore

      var peg$f27 = function (layer, centerX, centerY, radius, startAngle, sweepAngle, props) {
        // @ts-ignore
        return {
          // @ts-ignore
          type: 'Arc',
      ...
      var peg$f28 = function (text, x, y, rotation, mirror, hSize, vSize, props) {
        // @ts-ignore
        return {
          // @ts-ignore
          type: 'Text',
      ...
      var peg$f29 = function (x1, y1, x2, y2, props) {
        // @ts-ignore
        return {
          // @ts-ignore
          type: 'Wire',
      ...
      var peg$f30 = function (reference, x, y, rotation, flip, props) {
        // @ts-ignore
        return {
          // @ts-ignore
          type: 'Component',
                ...
                if (s9 !== peg$FAILED) {
                  ...
                  if (s11 !== peg$FAILED) {
                    ...
                    if (s13 !== peg$FAILED) {
                      ...
                      peg$savedPos = s0;
                      // @ts-ignore
                      s0 = peg$f22(s3, s5, s7, s9, s11, s13);
                      // @ts-ignore
                    } else {
                      // @ts-ignore
                      peg$currPos = s0;
                ...
                if (s9 !== peg$FAILED) {
                  ...
                  if (s11 !== peg$FAILED) {
                    ...
                    if (s13 !== peg$FAILED) {
                      ...
                      peg$savedPos = s0;
                      // @ts-ignore
                      s0 = peg$f23(s3, s5, s7, s9, s11, s13);
                      // @ts-ignore
                    } else {
                      // @ts-ignore
                      peg$currPos = s0;
                  ...
                  if (s11 !== peg$FAILED) {
                    ...
                    if (s13 !== peg$FAILED) {
                      ...
                      if (s15 !== peg$FAILED) {
                        ...
                        peg$savedPos = s0;
                        // @ts-ignore
                        s0 = peg$f27(s3, s5, s7, s9, s11, s13, s15);
                        // @ts-ignore
                      } else {
                        // @ts-ignore
                        peg$currPos = s0;
                    ...
                    if (s13 !== peg$FAILED) {
                      ...
                      if (s15 !== peg$FAILED) {
                        ...
                        if (s17 !== peg$FAILED) {
                          ...
                          peg$savedPos = s0;
                          // @ts-ignore
                          s0 = peg$f28(s3, s5, s7, s9, s11, s13, s15, s17);
                          // @ts-ignore
                        } else {
                          // @ts-ignore
                          peg$currPos = s0;
                ...
                if (s9 !== peg$FAILED) {
                  ...
                  if (s11 !== peg$FAILED) {
                    ...
                    if (s13 !== peg$FAILED) {
                      ...
                      peg$savedPos = s0;
                      // @ts-ignore
                      s0 = peg$f30(s3, s5, s7, s9, s11, s13);
                      // @ts-ignore
                    } else {
                      // @ts-ignore
                      peg$currPos = s0;
